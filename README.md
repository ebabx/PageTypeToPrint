...
PageTypeToPrint est développé par [Julien Bidoret](https://ateliers.esad-pyrenees.fr/web).  La maquette originale a été développée par [Perrine Saint Martin](https://typomorpho.fr/).  Ce dépôt est maintenu par [didier Lechenne](https://lechenne.fr). L’outil s’appuie sur plusieurs librairies : 
