...
// French prepositions
arts = ["un", "une", "le", "la", "les", "du", "de", "DE", "au", "aux", "se"];
dets = ["ce", "ces", "cet", "cette", "mes", "tes", "ses", "mon", "ton", "ma", "ta", "son", "sa", "notre", "votre", "leur", "nos", "vos", "leurs", "ne"];
prons = ["je", "tu", "il", "elle", "on", "nous", "vous", "ils", "Ils", "elles"];
conjs = ["mais", "où", "et", "donc", "or", "ni", "car", "ou", "que", "qui"];
short = ["à", "y", "en", "de", "par", "et"];
preps = ["non", "après", "avant", "avec", "chez", "concernant", "contre", "dans", "depuis", "derrière", "dès", "durant", "entre", "hormis", "jusqu’à", "jusque", "loin", "malgré", "moyennant", "outre", "parmi", "pour", "près", "sans", "selon", "sous", "suivant", "touchant", "très", "vers"];
